package com.zt.spring6.realize.core.bean;
    ...
    public AnnoAppContext(String basePackage) {
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                // ~/Code/Java/demo/JavaNote/d01_spring6/s03_ioc-realize/target/classes/com/zt/spring6/realize/test
                String filePath = URLDecoder.decode(url.getFile(), StandardCharsets.UTF_8);
                // ~/Code/Java/demo/JavaNote/d01_spring6/s03_ioc-realize/target/classes/
        ...
        if (fileParent.isDirectory()) {
            ...
            for (File childFile : childrenFiles) {
                if (childFile.isDirectory()) {
                    ...
                    // 通过文件路径转成全类名，com/zt/spring6/realize/test/UserService.class
                    String pathWithClass = childFile.getAbsolutePath().substring(rootPath.length());
                    // 选中 class 文件
                    if (pathWithClass.contains(".class")) {
                        // 去掉 .class 后缀，把 「\」 替换成 「.」，com.zt.spring6.realize.test.UserService
